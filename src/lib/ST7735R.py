...
"""
Used according to MIT License for TextBox by
Daniel Hennig and provided for download.

Tested with 1.77 Inch Screen from AliExpress
manufactured by TZT.
- Model Number: GMT177-01
- Resolution: 128 * 160 RGB
- Color: Full color 65K / 262K
- Vcc: 3.3 V
- Driver: COG / ST7735S
- Interface: 4-wire SPI

Thanks to Peter Hinch for providing this driver.
...
class ST7735R(framebuf.FrameBuffer):
    ...
    def __init__(self, spi, cs, dc, rst, height=160, width=128, usd=False, init_spi=False):
        self._spi = spi
        self._rst = rst  # Pins
        self._dc = dc
        self._cs = cs
